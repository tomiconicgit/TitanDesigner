const layoutStyles = `
    ...
    #control-panel {
        ...
        right: -200px; /* Start fully off-screen right */
        width: 200px; /* Initial small width */
        max-height: calc(100vh - 60px); /* Fit within screen height, accounting for toggle */
    ...
    #control-panel.open {
        right: 0; /* Slide in fully from the right */
    }

    #control-panel.expanded {
        width: calc(50vw - 20px); /* Halfway across screen with padding */
    }
